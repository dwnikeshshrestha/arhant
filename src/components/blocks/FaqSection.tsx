...
const DUMMY_FAQS = [
  {
    ...
    answer:
      "Yes, our IEnsure suites are built with advanced API architectures allowing seamless integration with your existing legacy systems and databases.",
  },
  {
    question: "Is IEnsure Life scalable for millions of policies?",
    answer:
      "Absolutely. IEnsure Life is engineered for the enterprise. Its robust microservices architecture guarantees optimal performance regardless of the volume of data.",
  },
  {
    question: "What is the typical deployment timeframe?",
    answer:
      "Depending on your specific customization needs, our standard deployment ranges from 6 to 12 weeks, including intensive QA and team training.",
  },
  {
    question: "Do you provide post-deployment technical support?",
    answer:
      "Yes, Arhant Solutions offers 24/7 dedicated support and regular software updates to ensure your operations are never interrupted.",
  },
];
...
export function FaqSection() {
  ...
  return (
    <ContainerLayout
      id="faq"
      className="bg-muted relative border-t border-foreground/5 !py-24"
    >
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          <SectionBadge label="FAQ" centered />
          ...
          {DUMMY_FAQS.map((faq, idx) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span className="font-heading font-bold text-foreground text-lg pr-8">
                    {faq.question}
                  </span>
                  {isOpen ? (
