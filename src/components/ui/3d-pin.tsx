...
export const PinContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative group/pin z-50  cursor-pointer card-container",
        containerClassName
      )}
        ...
        >
          <>
            <motion.div
              ...
              className="absolute left-1/2 top-1/2  h-[11.25rem] w-[11.25rem] rounded-[50%] bg-sky-500/[0.08] shadow-[0_8px_16px_rgb(0_0_0/0.4)] bg-white"
            ></motion.div>
            <motion.div
              initial={{
                opacity: 0,
